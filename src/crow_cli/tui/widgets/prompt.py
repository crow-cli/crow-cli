...
from crow_cli.tui.widgets.highlighted_textarea import HighlightedTextArea
from crow_cli.tui.widgets.condensed_path import CondensedPath
from crow_cli.tui.widgets.path_search import PathSearch
from crow_cli.tui.widgets.plan import Plan
from crow_cli.tui.widgets.question import Ask, Question
from crow_cli.tui.widgets.slash_complete import SlashComplete
from crow_cli.tui.messages import UserInputSubmitted
from crow_cli.tui.slash_command import SlashCommand
from crow_cli.tui.prompt.extract import extract_paths_from_prompt
from crow_cli.tui.path_complete import PathComplete
...
"""
    ...
    def highlight_shell(self, text: str) -> Content:
        ...
        from crow_cli.tui import danger
...
class Prompt(containers.VerticalGroup):
    ...
    def watch_modes(self, modes: dict[str, Mode] | None) -> None:
        from crow_cli.tui.visuals.columns import Columns
