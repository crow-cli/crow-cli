...
from crow_cli.tui import jsonrpc, messages
...
from crow_cli.tui.directory_watcher import DirectoryWatcher, DirectoryChanged
from crow_cli.tui.history import History
...
from crow_cli.tui.widgets.user_input import UserInput
from crow_cli.tui.shell import Shell, CurrentWorkingDirectoryChanged
from crow_cli.tui.slash_command import SlashCommand
from crow_cli.tui.protocol import BlockProtocol, MenuProtocol, ExpandProtocol
from crow_cli.tui.menus import MenuItem
from crow_cli.tui.widgets.shell_terminal import ShellTerminal

if TYPE_CHECKING:
    from crow_cli.tui.acp.agent import Mode
    from crow_cli.tui.widgets.terminal import Terminal
    from crow_cli.tui.widgets.agent_response import AgentResponse
    from crow_cli.tui.widgets.agent_thought import AgentThought
...
class Conversation(containers.Vertical):
    ...
    async def on_acp_tool_call_update(
        ...
        from crow_cli.tui.widgets.tool_call import ToolCall
    ...
    async def request_permissions(
        ...
        if kind == "edit":
            ...
            if diffs:
                from crow_cli.tui.screens.permissions import PermissionsScreen
        ...
        from crow_cli.tui.widgets.acp_content import ACPToolCallContent
    ...
    async def post_diff(self, path: str, before: str | None, after: str) -> None:
        ...
        from crow_cli.tui.widgets.diff_view import make_diff
    ...
    def ask(
        ...
        """
        from crow_cli.tui.widgets.question import Ask
