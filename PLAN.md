# PLAN — PostgreSQL memory backend (same treatment as RustFS)
...
## Phase 1 — mechanical portability
...
## Phase 4 — init/compose/config (the rustfs treatment)
